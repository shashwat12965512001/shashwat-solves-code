  ...
  const skillCategories = [
    {
      title: "Frontend",
      icon: Globe,
      skills: ["HTML", "CSS", "JavaScript", "React.js", "Next.js", "Tailwind CSS", "Flutter"],
      color: "text-blue-400"
    },
    {
      title: "Backend",
      icon: Code,
      skills: ["PHP", "Node.js", "Express.js", "Flask", "Python"],
      color: "text-green-400"
    },
    {
      title: "Languages & Databases", 
      icon: Database,
      skills: ["C", "C++", "Java", "Python", "Dart", "MongoDB", "MySQL", "Firebase"],
      color: "text-purple-400"
    },
    {
      title: "Tools & Concepts",
      icon: Wrench,
      skills: ["Git", "GitHub", "Postman", "Replit", "DSA", "OS", "OOPs", "DBMS", "APIs", "Deployment"],
      ...
      <div className="container mx-auto">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Data Structures", "Algorithms", "Greedy Algorithms", "Graph Algorithms", "Scheduling Algorithms", "Object-Oriented Programming"].map((fundamental, index) => (
              <div 
                key={index}
